 ...
 */
void __bh1750_i2c_write_command(BH1750_HandleTypeDef* hbh1750, std::uint8_t command);
 ...
 */
void __bh1750_i2c_read_data(BH1750_HandleTypeDef* hbh1750, std::uint8_t* data);
...
void __bh1750_i2c_write_command(BH1750_HandleTypeDef* hbh1750, std::uint8_t command)
{
  I2C_Master_Transmit(hbh1750->I2C, &command, BH1750_COMMAND_SIZE);
}

void __bh1750_i2c_read_data(BH1750_HandleTypeDef* hbh1750, std::uint8_t* data)
{
  I2C_Master_Receive(hbh1750->I2C, data, BH1750_DATA_SIZE);
}
...
{
  std::uint8_t rxarray[BH1750_DATA_SIZE];
